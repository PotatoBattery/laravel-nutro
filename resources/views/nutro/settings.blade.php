        ...
        <div class="content">
            <div class="block">
                <div class="setting-menu-item">
                    <label for="color">{{ __('settings.theme') }}</label>
                ...
                <div class="setting-menu-item">
                    ...
                    @if($locale == "en")
                        <a hreflang="ru" href="{{ Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL("ru", null, [], true) }}" class="language-link">English</a>
                    @else
